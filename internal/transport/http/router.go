...
func NewRouter(taskHandler *httphandlers.TaskHandler, notificationHandler *httphandlers.NotificationHandler, docsHandler *swaggerdocs.Handler) *mux.Router {
	...
	api.HandleFunc("/notifications", notificationHandler.List).Methods(http.MethodGet)
